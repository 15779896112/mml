# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-03-22 06:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createtime', models.DateTimeField(auto_now_add=True)),
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('goods', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Goods')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('old', models.CharField(default='', max_length=10)),
            ],
            options={
                'db_table': 'mml_user',
            },
